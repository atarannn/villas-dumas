    ...
    resources: {
      ...
      it: {
        translation: {
          ...
          text: 'Testo:*',
          phone: 'Telefono:*',
          field_too_short: 'Il telefono deve essere di almeno {{cnt}} caratteri',
          field_too_long: 'Il telefono deve essere al massimo di {{cnt}} caratteri',
          only_number: 'Inserire solo cifre qui',
          onlyletters: 'Il nome deve contenere solo lettere',
          validEmail: 'La posta deve essere valida',
          required: 'Questo campo è obbligatorio',
          sendingSuccessTitle: 'Messaggio inviato',
          sendingSuccessText: 'Aspetta le risposte dei nostri manager',
          sendingErrorText: 'Aspetta le risposte dei nostri manager',
          sendingErrorTitle: 'Si è verificato un errore',
          send_fail: 'Il messaggio non è stato inviato a causa di un errore del server sconosciuto. Codice: [send_fail]',
          invalid_form: 'Il messaggio non è stato inviato a causa di un errore del server sconosciuto. Codice: [invalid_form]',
          front_error: 'Il messaggio non è stato inviato a causa di un errore del server sconosciuto. Codice: [front_error]',
          invalid_upload_file: 'Errore durante il caricamento del file. Codice: [invalid_upload_file]',
